...
ALTER TABLE T_ProyeccionesListaPrecios ADD CONSTRAINT FKT_Proyecci761595 FOREIGN KEY (mes, anio) REFERENCES T_MesAnio (mes, anio);
...
ALTER TABLE T_Cotizaciones ADD CONSTRAINT FKT_Cotizaci344790 FOREIGN KEY (mesEntreg, anioEntreg) REFERENCES T_MesAnio (mes, anio);
ALTER TABLE T_TipoCambios ADD CONSTRAINT FKT_TipoCamb923514 FOREIGN KEY (mes, anio) REFERENCES T_MesAnio (mes, anio);
ALTER TABLE T_ProyeccionesListaPrecios ADD CONSTRAINT FKT_Proyecci905342 FOREIGN KEY (codListaPrecios) REFERENCES T_ListaPrecioXArticulos (codListaPrecio);
